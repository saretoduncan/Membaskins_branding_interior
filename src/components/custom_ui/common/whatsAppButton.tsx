...
const WhatsAppButton = () => {
  return (
    <a
      ...
      className="bg-green-600 rounded-2xl text-white flex  px-2 py-2 gap-2 items-center hover:bg-green-400 transition-all ease-in-out duration-300" target="_blank"
    >
